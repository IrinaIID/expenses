...
export const EXPENSES_CATEGORIES: Category[] = [
  { 
      category: "Housing",
      subcategories: ["Rent", "Mortgage", "Property Taxes", "Household Repairs", "Homeowner's/Renter's Insurance", "Other"]
  },
  {
      category: "Utilities",
  ...
  },
  {
      ...
      subcategories: ["Car Payment", "Car Insurance", "Gas", "Maintenance", "Public Transportation", "Parking Fees", "Ride-Sharing Services", "Other"]
  },
  {
      category: "Health Care",
      subcategories: ["Health Insurance", "Out-Of-Pocket Medical Costs", "Prescriptions", "Vitamins", "Gym Membership", "Other"]
  },
  {
      category: "Education",
  ...
  },
  {
      ...
      subcategories: ["Accountant", "Lawyer", "Financial Planner", "Other"]
  },
  {
      category: "Taxes",
